class ComputerScene extends Scene {
    ...
    update () {
        ...
        const isEnd = opponent.luser || player.luser; // если хоть одно true - игра окончена
        ...
        // если мышка находится над оппонентом (табличка), то нужуно узнать ячейку, над которой находится мышка
